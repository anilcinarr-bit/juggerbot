...
from app.platforms.n11 import HOME_URL, COUPON_PAGE_URL, COUPON_INPUT_SELECTOR, APPLY_BUTTON_SELECTOR, RESULT_SELECTOR
...
class N11Adapter(BaseAdapter):
    ...
    async def execute(self, coupon: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Navigate to N11 website
            logger.info("Opening N11...")
